...
public class Article {
    ...
    // Join column in the 'articles' table referencing the primary key in the 'users' table
    ...
    public Article(User author, String mainImage, String title, String description, String contentId, LocalDateTime publicationDate, Long viewCount) {
        this.author = author;
    ...
    public Article(String mainImage, String title, String description, String contentId, LocalDateTime publicationDate, Long viewCount) {
        this.mainImage = mainImage;
        this.title = title;
        this.description = description;
        this.contentId = contentId;
    ...
    public Article(Long id, String mainImage, String title, String description, String contentId, LocalDateTime publicationDate, Long viewCount) {
        this.id = id;
        this.mainImage = mainImage;
        this.title = title;
        this.description = description;
