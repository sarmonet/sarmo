// pages/api/analytics/users-overview.ts
...
const handler = async (req: NextApiRequest, res: NextApiResponse) => {
	...
	try {
		...
		const metrics = [{ name: 'totalUsers' }, { name: 'newUsers' }]
		...
		console.error('Ошибка в API-маршруте /api/analytics/users-overview:', error)
